...
namespace Ujeby.UgUi.Core
{
	...
	public abstract class NodeOperationBase : INotifyPropertyChanged, INode, ILoggable, ISerializableNode
	{
		#region INode
		...
		public void DeserializeData(string serializedData)
		{
			...
			foreach (var serializableProperty in allSerializableProperties)
			{
				...
				if (value != null)
					serializableProperty.SetValue(this, Common.Convert.ChangeType(deserialized[serializableProperty.Name].Value as string, serializableProperty.PropertyType));
			}
		}
	}
}
